...
$kegiatan = data("SELECT * FROM kegiatan LIMIT $awaldata, $jumlahdataperhalaman");
...
<body>
<h3> <i class="fa fa-bicycle mr-3"> </i>DATA KEGIATAN</i></h3><hr> 
...
<div class="pull-right">
  <a href="?page=kegiatan" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-refresh"></i></a>
  <a href="?page=tambahKegiatan" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i>Tambah Data</a>
</div>
